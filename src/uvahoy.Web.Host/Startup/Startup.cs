...
namespace uvahoy.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "uvahoy API", Version = "v1" });
            ...
            return services.AddAbp<uvahoyWebHostModule>(
        ...
        {
            app.Properties["host.AppName"] = "uvahoy";
